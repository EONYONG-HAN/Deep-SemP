...
# Spearman rank correlation (robust to n=5 and to tied/approximate divergence)
rho, p_s = stats.spearmanr(divergence, entropies)

# OLS only to draw a guide line — NOT reported as a statistic
...
#         color='#888780', lw=1.2, alpha=0.6, zorder=3,
#         label='Linear fit')

ax.scatter(divergence, entropies, c=colors, s=110,
           zorder=5, edgecolors='white', linewidth=1.3)

# Spearman annotation in-plot
ax.text(0.97, 0.06, f'Spearman $\\rho$ = {rho:.2f}',
...
plt.tight_layout()
plt.savefig('entropy_vs_phylogeny_v2.pdf', dpi=300,
            bbox_inches='tight', facecolor='white', edgecolor='none')
plt.savefig('entropy_vs_phylogeny_v2.png', dpi=300,
            bbox_inches='tight', facecolor='white', edgecolor='none')
plt.show()
