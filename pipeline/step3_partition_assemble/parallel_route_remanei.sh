...
R1="${R1:-/data3/projects/2025_Assembly/eyh/c_remanei/raw_data/c_remanei_R1.fastq.gz}"
R2="${R2:-/data3/projects/2025_Assembly/eyh/c_remanei/raw_data/c_remanei_R2.fastq.gz}"
OUTPUT_DIR="${OUTPUT_DIR:-/data3/projects/2025_Assembly/eyh/c_remanei/partitioned_reads/student_nh_illumina5}"
