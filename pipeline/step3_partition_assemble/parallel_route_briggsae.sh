...
R1="${R1:-/data3/projects/2025_Assembly/eyh/c_briggsae/raw_data/briggsae_merged_R1.fastq.gz}"
R2="${R2:-/data3/projects/2025_Assembly/eyh/c_briggsae/raw_data/briggsae_merged_R2.fastq.gz}"
OUTPUT_DIR="${OUTPUT_DIR:-/data3/projects/2025_Assembly/eyh/c_briggsae/partitioned_reads/student_nh_illumina5_merged}"
...
echo "=============================================="
echo "  Parallel Read Routing — C. briggsae"
...
echo "=============================================="
echo "  COMPLETE — C. briggsae routing"
echo "=============================================="
