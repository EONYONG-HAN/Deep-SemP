#!/usr/bin/env bash
# =============================================================
# Parallel read routing via FASTQ chunking
# Pipeline:
#   1) Split R1 + R2 into N chunks
#   2) Run N routing jobs in parallel on separate GPUs
#   3) Merge per-bucket outputs across chunks
#   4) Report total timing
# =============================================================
set -euo pipefail
...
# =========================
N_CHUNKS=4
GPUS=(0 1 3 3)          # all chunks on GPU 2 — sequential execution
...
# R1="/data3/projects/2025_Assembly/eyh/c_elegans/real_data/SRR36278209_1.fastq.gz" #previous
# R2="/data3/projects/2025_Assembly/eyh/c_elegans/real_data/SRR36278209_2.fastq.gz"
# R1="/data3/projects/2025_Assembly/eyh/c_elegans_deg/merged_day5_1.fastq.gz" #DEG_ANAYLSIS
# R2="/data3/projects/2025_Assembly/eyh/c_elegans_deg/merged_day5_2.fastq.gz"
R1="${R1:-/data3/projects/2025_Assembly/eyh/c_elegans_deg/contrasts/daf16_aging/merged_1.fastq.gz}"
R2="${R2:-/data3/projects/2025_Assembly/eyh/c_elegans_deg/contrasts/daf16_aging/merged_2.fastq.gz}" # DEG_daf16_re-run


OUTPUT_DIR="${OUTPUT_DIR:-/data3/projects/2025_Assembly/eyh/c_elegans_deg/partitioned_reads/student_nh_illumina5_contrast}"
...
BATCH_SIZE=12288
FP16="--fp16"
ZSTD_THREADS=4       # threads for zstd compression per split job
...
# Round up to nearest multiple of 4 (FASTQ record = 4 lines)
...
# Per-bucket distribution from merged files
