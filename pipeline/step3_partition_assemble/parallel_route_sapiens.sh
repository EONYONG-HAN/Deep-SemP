...
OUTPUT_DIR="${OUTPUT_DIR:-/data3/projects/2025_Assembly/eyh/h_sapiens/partitioned_reads/student_nh_illumina5}"
...
echo "=============================================="
echo "  Parallel Read Routing — H. sapiens"
...
echo "=============================================="
echo "  COMPLETE — H. sapiens routing"
echo "=============================================="
